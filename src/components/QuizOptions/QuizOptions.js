...
const QuizOptions = ({option, options, correctAnswer}) => {
  ...
  return (
    <div class="flex items-center pl-4 rounded border border-rose-700">
        <label onClick={option === correctAnswer ? showSuccessToastMessage : showErrorToastMessage} class="py-4 ml-2 w-full text-sm font-medium text-rose-800">
          <span className='pr-3'>
