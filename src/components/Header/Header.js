            ...
            <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
                ...
                <div className="flex justify-between ">
                    <div className=" flex space-x-3 items-center">
                        ...
                        <h1 className=" font-normal text-2xl leading-6 text-gray-800">Quiz Mania</h1>
                    </div>
                    <div className="hidden sm:flex flex-row space-x-4">
                        <Link to='/' className="flex space-x-2 w-24 h-10 font-normal text-sm leading-3 text-indigo-700 bg-white focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center">Topics</Link>
                        <Link to='/statistics' className="flex space-x-2 w-24 h-10 font-normal text-sm leading-3 text-indigo-700 bg-white focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center">Statistics</Link>
                        <Link to='/blog' className="flex space-x-2 w-24 h-10 font-normal text-sm leading-3 text-indigo-700 bg-white focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center">Blog</Link>
                    </div>
                    {/* Burger Icon */}
                ...
                <div id="MobileNavigation" className={`${show ? 'block' : 'hidden'} sm:hidden mt-4 mx-auto`}>
                    <div className="flex flex-col gap-4 mt-4 w-80 mx-auto ">
                        <Link to='/' className="flex space-x-2 w-full h-8 font-normal text-sm leading-3 text-indigo-700 bg-indigo-600 bg-opacity-0 hover:opacity-100 duration-100 focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center">Topics</Link>
                        <Link to='/statistics' className="flex space-x-2 w-full h-8 font-normal text-sm leading-3 text-indigo-700 bg-indigo-600 bg-opacity-0 hover:opacity-100 duration-100 focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center">Statistics</Link>
                        <Link to='/blog' className="flex space-x-2 w-full h-8 font-normal text-sm leading-3 text-indigo-700 bg-indigo-600 bg-opacity-0 hover:opacity-100 duration-100 focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center">Blog</Link>
                    </div>
                </div>
            </nav>
        </div>
