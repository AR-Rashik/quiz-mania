...
const Blog = () => {
  return (
    <div className='mt-10'>
      <div className='text-3xl text-center text-rose-800 mb-3 w-9/12 mx-auto font-bold'>Blog</div>
      <div className='border-b-2 border-rose-200 mb-8 w-9/12 mx-auto'></div>
      <div className='w-9/12 mx-auto border-2 bg-rose-50 border-rose-400 p-3 mb-8 rounded-md shadow-md'>
        <h3 className='font-semibold text-xl mb-4 border-b-2 border-rose-200 pb-2 text-rose-800'>1. What is the purpose of react router?</h3>
      ...
      <div className='w-9/12 mx-auto border-2 bg-rose-50 border-rose-400 p-3 mb-8 rounded-md shadow-md'>
        <h3 className='font-semibold text-xl mb-4 border-b-2 border-rose-200 pb-2 text-rose-800'>2. How does context API works?</h3>
        <div className='text-lg text-rose-800'>
      ...
      <div className='w-9/12 mx-auto border-2 bg-rose-50 border-rose-400 p-3 mb-8 rounded-md shadow-md'>
        <h3 className='font-semibold text-xl mb-4 border-b-2 border-rose-200 pb-2 text-rose-800'>3. What is useRef hook?</h3>
        <div className='text-lg text-rose-800'>
